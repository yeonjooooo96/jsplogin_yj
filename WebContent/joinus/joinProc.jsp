...
if(errors.size()>0){//에러가 생기면
	request.setAttribute("errors", errors);
	//response.sendRedirect("join.jsp");
	request.getRequestDispatcher("join.jsp").forward(request, response);//에러의 값을 같이 전달해줌 join.jsp에
}else{
...
out.println(day+"<br />");
out.println(IsLunar+"<br />");
out.println(cphone+"<br />");
